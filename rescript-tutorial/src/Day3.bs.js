...
function getRoute(down, right, param) {
  var width = param[1];
  var __x = Belt_Array.range(0, param[0] - 1 | 0);
  var __x$1 = __x.filter(function (y) {
        return Caml_int32.mod_(y, down) === 0;
      });
  return __x$1.map(function (y, x) {
              return [
                      y,
...
var test_tree = input_to_tree_map(Day3Input.test_input);
...
var real_tree = input_to_tree_map(Day3Input.raw_input);
