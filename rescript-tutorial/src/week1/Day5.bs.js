...
function sum_of_arithmetic_seq(from, end, d) {
  return Caml_int32.div(Math.imul(from + end | 0, (end - from | 0) + 1 | 0), d) / 2 | 0;
}
...
function find_my_seat(l) {
  return sum_of_arithmetic_seq(min(l), max(l), 1) - sum(l) | 0;
}
